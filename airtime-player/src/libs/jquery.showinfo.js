    ...
    $.fn.airtimeLiveTrackInfo = function(options) {
       ...
       return this.each(function() {
           ...
           function updateWidget(){
               ...
               //JC Changes
               obj.append("<h4>"+showStatus+"</h4>");
               obj.append("<p class=\"current-info\">"+
               		 "<span class='current track-metadata'>" + sd.currentTrack.getTitle()+"</span>" +
								"</p>");
               obj.append("<p class=\"next-info\"><strong>Next:</strong>" +sd.nextTrack.getTitle()+"</p>");




               //obj.append("<p>"+currentShowName+"</p>");
